...
class PythonExecTool(ToolInterface):
  ...
  @staticmethod
  def _run_code_in_container(code: str, container_name: str = os.getenv("DEFAULT_SANDBOX_CONTAINER_NAME")) -> Tuple[str, str]:
    """
    Helper function that actually runs Python code inside a Docker container named 'python_sandbox' (by default).
    """
